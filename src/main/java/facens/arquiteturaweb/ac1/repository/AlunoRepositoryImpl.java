...
public class AlunoRepositoryImpl implements AlunoRepository {
    ...
    public AlunoRepositoryImpl() {
        ...
        alunos.add(new Aluno(1L, "Giovani", "ADS", "Limeira", "apaixonado", "Masculino"));
        alunos.add(new Aluno(2L, "David", "Metrologia", "São Roque", "hétero", "Masculino"));
        alunos.add(new Aluno(3L, "Vinicius", "Engenharia Civil", "São Roque", "hétero", "Masculino"));
